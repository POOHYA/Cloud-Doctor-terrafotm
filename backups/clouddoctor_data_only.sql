...
INSERT INTO public.guidelines VALUES (19, 'MFA 미설정', 1, 3, '중요', 'MFA가 설정되어 있지 않은 계정은 비밀번호 유출/재사용/브루트포스 공격으로 즉시 탈취될 수 있으므로, 콘솔 로그인 보호의 최종 방어선이 부재한 상태입니다.
...
INSERT INTO public.guidelines VALUES (11, 'IAM 자격증명 평문 저장으로 인한 유출', 1, 3, '중요', '소스코드에 평문으로 저장된 AWS 자격증명은 누구나 해당 파일을 내려받아 즉시 재사용할 수 있으므로, 자격증명이 노출되면 계정 및 리소스에 대한 무단 접근이 즉각적으로 가능해집니다.
...
INSERT INTO public.guidelines VALUES (13, 'IAM 루트 계정 Access Key 관리 실패', 1, 3, '긴급', '루트 계정 Access Key는 계정 내 모든 권한을 행사할 수 있어 유출될 경우 즉시 전 범위의 리소스에 무단 접근이 가능해집니다.
...
INSERT INTO public.guidelines VALUES (15, 'IAM PassRole으로 비인가자의 영구적 권한 획득', 1, 3, '확인요망', 'iam:PassRole 권한이 있으면 공격자가 자신이 가진 권한 범위 밖의 역할(Role)을 AWS 서비스에 붙여 그 역할의 권한을 악용할 수 있습니다. 즉, 단순히 ‘역할을 전달’할 수 있는 권한만으로도 임시 자격증명 획득후 권한 상승이 가능해집니다.
...
INSERT INTO public.guidelines VALUES (17, 'Cross-Account 접근 설정 미흡', 1, 3, '중요', 'Cross-Account 신뢰 정책을 단순히 계정 ID나 역할 ARN만으로 넓게 허용하면, 제3자(예: SaaS)가 정상적으로 행하는 역할 획득 흐름이 공격자에게도 열려 있게 됩니다. 이 경우 공격자는 정상 서비스의 기능을 악용하여 고객 계정의 권한을 대신 받아 민감 자원에 접근하거나 다른 계정으로 권한을 전파할 수 있습니다.
...
INSERT INTO public.guidelines VALUES (16, 'Identity Federation을 통한 비인가자의 역할 취득 및 리소스 접근', 1, 3, '중요', 'Identity Federation을 통해 외부 IdP(사내 AD/Okta/Google Workspace 등) 계정으로 AWS 역할을 취득하게 하면, 해당 IdP에서 인증된 사용자는 AWS 리소스에 접근할 수 있습니다.
...
INSERT INTO public.guidelines VALUES (18, '퇴직자의 IAM 권한 미철회로 인한 유출 위험', 1, 3, '긴급', '퇴직자의 IAM 권한을 즉시 철회하지 않으면 더 이상 접근할 필요가 없는 계정과 키가 그대로 남아 있게 되고, 이는 조직 리소스에 무단 접근할 수 있는 위험을 초래합니다.
...
INSERT INTO public.guidelines VALUES (22, 'Lambda 코드/환경변수에 중요정보 노출', 1, 5, '중요', 'Lambda 환경에는 함수가 실행될 때 사용되는 임시 IAM 자격증명과 함수를 호출한 요청 데이터가 존재합니다. 이 정보들이 함수의 환경변수나 런타임에서 평문으로 남아 있거나, 함수가 외부 입력을 통해 내부 파일이나 내부 서비스에 접근하도록 허용하면, 공격자는 그 정보를 탈취해 S3/EC2/IAM 등 다른 AWS 리소스에 접근할 수 있습니다.', '공격자는 웹 애플리케이션의 파일 읽기 취약점이나 함수 로직의 입력 반영 취약점을 이용해 Lambda의 환경변수나 실행 정보(환경설정 등)를 노출시킬 수 있으며, 탈취한 임시 자격증명으로 S3/DB/IAM 등으로 접근해 데이터 유출/권한 확대를 수행합니다.', '🧭 Lambda → 함수 → [대상 함수 명] → 구성 탭 → 환경 변수
...
INSERT INTO public.guidelines VALUES (26, 'CloudTrail 비활성화 시 로그 미수집으로 인한 추적 불가 위험성', 1, 7, '확인요망', 'CloudTrail은 AWS 계정에서 발생하는 모든 활동(누가, 언제, 무엇을 했는지)을 기록하는 ''보안 블랙박스''와 같습니다. 이 기록은 해킹 사고가 발생했을 때 공격 경로를 파악하고 피해를 복구하는 데 결정적인 증거가 됩니다.
...
INSERT INTO public.guidelines VALUES (27, 'CloudTrail 비정상적인 API 호출 감시 미흡', 1, 7, '중요', 'CloudTrail은 계정에서 발생한 모든 API 호출을 기록해 사고 탐지/조사/대응의 근거를 제공합니다.
...
INSERT INTO public.guidelines VALUES (30, 'SNS 주제 액세스 정책 과다 허용으로 인한 SMS 스미싱 악용', 1, 10, '중요', 'SNS는 특정 주제에 대해서 구독자가 있고, 그 주제에 새로운 정보를 Publish하면 그 구독자가 그 정보를 받아갈 수 있습니다.
...
INSERT INTO public.guidelines VALUES (31, 'SQS 큐 정책 과도 권한', 1, 11, '중요', '서버들 사이에 처리해야 할 중요한 작업 목록(메시지)을 안전하게 전달하는 SQS 큐에 Queue Policy(큐 정책)를 설정할 때, 실수로 Principal을 전체(*)로 설정하거나 조건을 너무 넓게 허용하는 경우가 있습니다.
...
INSERT INTO public.guidelines VALUES (32, 'Route 53 DNS 레코드 미정리로 인한 Takeover', 1, 12, '중요', '사용자가 S3 버킷, EC2 인스턴스 같은 AWS 클라우드 자원을 삭제할 때, 해당 자원을 가리키던 DNS 레코드(CNAME)나 CloudFront 배포 설정을 함께 삭제하는 것을 잊어버리면 DNS 레코드는 ''댕글링(Dangling)'' 상태, 즉, 존재하지 않는 주소를 계속 가리키는 상태로 남아있게 됩니다.', '공격자는 탈취한 도메인(서브도메인)을 이용해 피싱 페이지, 악성 스크립트, 또는 멀웨어를 호스팅하고, 원래 도메인의 신뢰도를 유지한 채 사용자에게 전달합니다.
...
INSERT INTO public.guidelines VALUES (33, 'Organizations Trusted Access 관리 미흡으로 조직 전체 계정 장악', 1, 13, '긴급', '신뢰할 수 있는 액세스(Trusted Access)를 활성화하면 특정 AWS 서비스가 조직 전체에 대해 자동으로 서비스 전용 권한을 획득해 멤버 계정에서 리소스를 생성하고 변경할 수 있습니다.
...
INSERT INTO public.guidelines VALUES (34, 'Organizations SCP 미적용으로 인한 불필요 API 호출', 1, 13, '중요', '서비스 제어 정책(Service Control Policy)를 적용하지 않으면 조직 차원의 최상위 가드레일이 사라져 멤버 계정에서 실행 가능한 API 범위를 중앙에서 제한할 수 없습니다.
...
INSERT INTO public.guidelines VALUES (35, '잘못된 ECR 관련 정책으로 인한 악성코드 위협', 1, 14, '중요', 'ECR 리포지토리는 리소스 기반 정책을 지원합니다. 여기서 Principal을 전체(*)로 설정하면 누구나 Push/Pull 할 수 있는 리포지토리가 됩니다. 쓰기(Push) 권한이 외부에 열려 있으면 악성 이미지 업로드, 기존 태그 덮어쓰기(태그 하이재킹), 이미지 삭제가 가능해집니다.
...
INSERT INTO public.guidelines VALUES (36, 'SendCommand(RunCommand)를 통한 EC2에서의 악성 셸 명령 실행', 1, 15, '긴급', 'AWS Systems Manager의 RunCommand 기능은 EC2 인스턴스에 스크립트나 명령을 비대화형으로 전송할 수 있는 기능입니다.
...
INSERT INTO public.guidelines VALUES (38, 'GuardDuty 비활성화로 인한 위협 탐지 실패', 1, 16, '중요', 'GuardDuty는 계정/리전 전반에서 VPC 플로우/CloudTrail 관리/S3 데이터 이벤트/DNS 로그 등을 상시 분석해 위협을 탐지하는 기본 방어선입니다. GuardDuty가 활성화되어 있지 않거나 조직 단위로 배포/자동 활성화되지 않으면 이러한 이상 징후를 놓쳐 초기 침해를 식별/차단하지 못해 공격자가 장기간 잠복 활동할 수 있기 때문에 위험합니다.', 'GuardDuty를 사용하지 않으면, AWS 계정과 리소스에서 발생하는 비정상 행위나 침해 징후를 실시간으로 감지하지 못해, 공격자가 장기적으로 내부에 머무르며 활동할 가능성이 커집니다.
...
INSERT INTO public.guidelines VALUES (40, 'Cognito Self-sign-up 허용으로 인한 비인가 계정 생성 위험', 1, 17, '확인요망', 'Cognito Self-sign-up을 허용하면 외부의 누구나(스팸/봇/공격자 포함) 사용자 계정을 생성할 수 있으므로, 악성 계정이 대량으로 생성되어 서비스 오용/스팸/브루트포스/자격증명 남용의 발판이 됩니다.
...
INSERT INTO public.guidelines VALUES (41, 'Cognito 토큰 클레임 신뢰 오류로 인한 계정 하이재킹', 1, 17, '확인요망', 'Cognito가 발급하는 JWT(JSON Web Token)의 access_token은 발급 시점의 클레임(사용자/권한/만료 등 속성)을 포함합니다. 공격자가 Cognito API로 자신의 유저 속성(예: email)을 변경하면 User Pool의 유저 레코드는 즉시 갱신됩니다.
...
INSERT INTO public.guidelines VALUES (42, 'CloudFormation의 PassRole으로 인한 권한 상승', 1, 18, '중요', 'CloudFormation은 스택 실행 시 호출 주체가 PassRole로 지정한 실행 역할(RoleARN)의 권한으로 리소스를 만들고 바꿉니다. 따라서 CreateStack 요청에 고권한 역할을 전달하면, CloudFormation이 그 역할을 대신 사용해 권한 상승과 IAM 리소스 생성까지 수행할 수 있습니다.', '공격자는 노출된 키/권한으로 cloudformation:CreateStack을 실행해 악의적 템플릿을 배포하고, 템플릿에서 관리자 권한을 가진 실행 역할을 PassRole하여 새 사용자나 자격증명을 생성/회수하게 해 계정 전반에 대한 영속적인 접근을 확보합니다.
...
INSERT INTO public.guidelines VALUES (44, 'Elastic Beanstalk 환경 속성/애플리케이션 번들 내 민감정보 노출로 인한 데이터 유출', 1, 20, '확인요망', 'Elastic Beanstalk는 애플리케이션 배포를 간편하게 해주는 관리형 플랫폼이지만, 환경 속성에 비밀번호, API 키, 토큰, 인증서와 같은 민감정보들이 남기 쉬워 민감정보나 자격증명이 노출될 수 있습니다.
...
INSERT INTO public.guidelines VALUES (51, 'AppStream 2.0 환경을 통한 과도한 권한 및 자격 증명 탈취', 1, 27, '확인요망', 'AppStream 2.0은 클라우드에서 데스크톱/애플리케이션을 실행하고 화면만 스트리밍하는 서비스라서 앱은 AWS 인프라 내부에서 실행됩니다.
...
INSERT INTO public.checklists VALUES (12, 1, 3, 11, '시크릿 스캐닝 도구를 통한 자격증명 평문 저장 여부 점검(ex. Trufflehog, Gitleaks 등으로 외부/공개 저장소 속 자격증명 평문 저장 점검)', true, '2025-10-20 17:34:50.80202', '2025-10-20 17:34:50.80202', 2);
INSERT INTO public.checklists VALUES (13, 1, 3, 12, '액세스 키가 생성된 후 90일 이내', true, '2025-10-20 17:35:04.1744', '2025-10-20 17:35:04.1744', 2);
INSERT INTO public.checklists VALUES (14, 1, 3, 13, '루트 계정의 Active 액세스 키 비활성화', true, '2025-10-20 17:35:29.023074', '2025-10-20 17:35:29.023074', 2);
INSERT INTO public.checklists VALUES (15, 1, 3, 13, '루트를 포함한 모든 사용자 계정의 MFA 활성화', true, '2025-10-20 17:35:42.774143', '2025-10-20 17:35:42.774143', 2);
INSERT INTO public.checklists VALUES (16, 1, 3, 14, '신뢰 정책에 사용할 계정/역할/서비스의 ARN으로 Principal 제한 및 Condition 활용', true, '2025-10-20 17:35:55.689718', '2025-10-20 17:35:55.689718', 2);
INSERT INTO public.checklists VALUES (17, 1, 3, 15, 'iam:PassRole 권한 사용 시, Resource를 특정 ARN으로 제한', true, '2025-10-20 17:36:12.298365', '2025-10-20 17:36:12.298365', 2);
INSERT INTO public.checklists VALUES (18, 1, 3, 16, 'IdP 연동 시, AssumeRole 정책 속 Principal은 특정 IdP의 ARN으로, Condition은 허용되는 IdP속성 값으로 제한', true, '2025-10-20 17:43:54.632385', '2025-10-20 17:43:54.632385', 2);
INSERT INTO public.checklists VALUES (19, 1, 3, 17, 'Cross-Account용 IAM 역할의 AssumeRole 정책 속 Principal은 특정 Provider/역할의 ARN으로,  Condition은 sts:ExternalId로 제한', true, '2025-10-20 17:44:45.180494', '2025-10-20 17:44:45.180494', 2);
INSERT INTO public.checklists VALUES (20, 1, 3, 18, '퇴직자 계정 권한 철회(ex. 콘솔 로그인 프로필, 액세스 키, 연결된 권한 정책, MFA, 인증서, 서비스 자격증명을 모두 삭제/해제)', true, '2025-10-20 17:45:08.127564', '2025-10-20 17:45:08.127564', 2);
INSERT INTO public.checklists VALUES (21, 1, 3, 18, '퇴직자 계정 활동 모니터링 및 로그 관리 운영체계 수립(ex. ConsoleLogin, CreateAccessKey 등의 잔여된 의심 활동을 탐지하기 위한 CloudTrail 쿼리 작성)', true, '2025-10-20 17:45:18.105372', '2025-10-20 17:45:18.105372', 2);
INSERT INTO public.checklists VALUES (22, 1, 4, 21, '외부 노출이 강력히 제한되어야 하는 내부 네트워크 운영 시, 배스천 호스트 구축', true, '2025-10-20 17:46:58.209166', '2025-10-20 17:46:58.209166', 2);
INSERT INTO public.checklists VALUES (23, 1, 5, 22, 'Lambda 함수 실행 시, 환경 변수를 KMS의 고객 마스터 키로 사용', true, '2025-10-20 17:47:48.584573', '2025-10-20 17:47:48.584573', 2);
INSERT INTO public.checklists VALUES (24, 1, 5, 23, 'Lambda 함수에 결함이 존재하는 코드 스캔(ex. Inspector 연동 및 사용 후 결과에서 심각도 HIGH, CRITICAL 미포함)', true, '2025-10-20 17:48:01.942166', '2025-10-20 17:48:01.942166', 2);
INSERT INTO public.checklists VALUES (25, 1, 6, 24, 'RDS의 DB 스냅샷 가시성이 프라이빗으로 설정', true, '2025-10-20 17:48:20.167131', '2025-10-20 17:48:20.167131', 2);
INSERT INTO public.checklists VALUES (26, 1, 6, 25, 'RDS의 퍼블릭 액세스 항목이 아니오로 설정', true, '2025-10-20 17:49:53.545763', '2025-10-20 17:49:53.545763', 2);
INSERT INTO public.checklists VALUES (27, 1, 6, 25, 'RDS의 DB 서브넷 그룹에 포함된 모든 서브넷을 프라이빗으로 설정', true, '2025-10-20 17:50:02.722438', '2025-10-20 17:50:02.722438', 2);
INSERT INTO public.checklists VALUES (28, 1, 7, 26, 'CloudTrail 추적에서 Organization 계층을 포함한 추적 로깅 활성화', true, '2025-10-20 17:50:17.797343', '2025-10-20 17:50:17.797343', 2);
INSERT INTO public.checklists VALUES (29, 1, 7, 27, 'CloudTrail 추적의 API 활동(읽기/쓰기) 모두 활성화', true, '2025-10-20 17:50:26.315542', '2025-10-20 17:50:26.315542', 2);
INSERT INTO public.checklists VALUES (30, 1, 7, 27, '비정상적인 API 호출 모니터링 및 로그 관리 운영체계 수립(ex. 대량 호출 RunInstances를 탐지 가능한 CloudTrail 쿼리 작성)', true, '2025-10-20 17:50:35.841097', '2025-10-20 17:50:35.841097', 2);
INSERT INTO public.checklists VALUES (31, 1, 8, 28, 'EKS 서비스 계정에 연결된 IAM 역할 정책 속 Action은 필요 권한으로, Resource는 특정 ARN으로 제한', true, '2025-10-20 17:50:47.41417', '2025-10-20 17:50:47.41417', 2);
INSERT INTO public.checklists VALUES (32, 1, 8, 28, 'EKS 사용 시, 쿠버네티스의 서비스 계정별로 IAM 역할 할당', true, '2025-10-20 17:50:58.900154', '2025-10-20 17:50:58.900154', 2);
INSERT INTO public.checklists VALUES (33, 1, 9, 29, 'KMS에서 외부 고객 관리형 키 Import 시, 만료 기간 설정', true, '2025-10-20 17:51:11.791358', '2025-10-20 17:51:11.791358', 2);
INSERT INTO public.checklists VALUES (34, 1, 9, 29, 'KMS에서 외부 고객 관리형 키 Reimport/삭제 시, 키 정책 속 Action은 특정 권한으로 제한되어 있고, Resource는 해당 고객 관리형 키의 ARN으로 제한하고, MFA를 강제', true, '2025-10-20 18:05:03.363129', '2025-10-20 18:05:03.363129', 2);
INSERT INTO public.checklists VALUES (35, 1, 9, 29, 'KMS에서 외부 고객 관리형 키의 키 정책 속 Principal의 KMS 관련 고위험 권한(ex. kms:ImportKeyMaterial, kms:decrypt)을 특정 고객 관리형 키의 역할 ARN으로 제한', true, '2025-10-20 18:05:16.57893', '2025-10-20 18:05:16.57893', 2);
INSERT INTO public.checklists VALUES (36, 1, 10, 30, 'SNS 주제 액세스 정책에서 sns:Publish, sns:Subscribe을 포함한 SNS 관련 권한이 Principal은 특정 ARN으로, Resource는 해당 주제의 ARN으로 제한', true, '2025-10-20 18:05:29.727617', '2025-10-20 18:05:29.727617', 2);
INSERT INTO public.checklists VALUES (37, 1, 11, 31, 'SQS 큐 정책 속 Principal이 특정 계정/역할/서비스의 ARN으로 제한', true, '2025-10-20 18:06:07.540679', '2025-10-20 18:06:07.540679', 2);
INSERT INTO public.checklists VALUES (38, 1, 12, 32, 'Route 53 레코드에 실제 소유/운영 중인 리소스만 존재', true, '2025-10-20 18:06:21.016038', '2025-10-20 18:06:21.016038', 2);
INSERT INTO public.checklists VALUES (39, 1, 13, 33, 'Organizations의 신뢰할 수 있는 액세스가 업무상 필요한 서비스에만 활성화', true, '2025-10-20 18:06:37.598267', '2025-10-20 18:06:37.598267', 2);
INSERT INTO public.checklists VALUES (40, 1, 13, 34, 'Organizations SCP 정책 속 불필요한 API(ex. ModifyReservedInstances, aws-marketplace:Subscribe)에 대해 Deny로 설정', true, '2025-10-20 18:06:53.127927', '2025-10-20 18:06:53.127927', 2);
INSERT INTO public.checklists VALUES (41, 1, 14, 35, 'ECR 리포지토리 정책 속 Principal을 리소스에 접근할 역할 ARN으로 제한', true, '2025-10-20 18:07:06.314398', '2025-10-20 18:07:06.314398', 2);
INSERT INTO public.checklists VALUES (42, 1, 14, 35, 'ECR의 이미지 스캔과 태그 불변성 활성화', true, '2025-10-20 18:07:17.472011', '2025-10-20 18:07:17.472011', 2);
INSERT INTO public.checklists VALUES (44, 1, 15, 37, 'SSM 문서를 프라이빗으로 설정', true, '2025-10-20 18:08:00.579666', '2025-10-20 18:08:00.579666', 2);
INSERT INTO public.checklists VALUES (45, 1, 16, 38, 'GuardDuty에서 모든 멤버 계정과 모든 사용 리전에 일괄 활성화 적용 및 신규 계정 자동 가입 설정', true, '2025-10-20 18:08:18.290237', '2025-10-20 18:08:18.290237', 2);
INSERT INTO public.checklists VALUES (48, 1, 17, 41, 'Cognito에서 토큰 만료 시간을 애플리케이션 운영에 필요한 최소 시간으로 설정(ex. 액세스/ID 토큰은 15분~60분, 갱신 토큰은 7일~30일, 기준은 조직 정책에 따라 정의)', true, '2025-10-20 18:08:53.425148', '2025-10-20 18:08:53.425148', 2);
INSERT INTO public.checklists VALUES (43, 1, 15, 36, 'ssm:SendCommand 권한 사용 시, 실행 대상의 리소스 ARN으로 제한', true, '2025-10-20 18:07:49.119131', '2025-10-20 18:07:49.119131', 2);
INSERT INTO public.checklists VALUES (46, 1, 17, 39, 'Cognito Identity Pool에 연결된 IAM 역할 정책 속 Action은 필요 권한으로, Resource는 해당 역할이 접근 가능한 리소스의 ARN으로, Condition은 비인증(Unauthenticated) 역할에 대한 민감 리소스 접근 권한을 제한', true, '2025-10-20 18:08:31.109564', '2025-10-20 18:08:31.109564', 2);
INSERT INTO public.checklists VALUES (47, 1, 17, 40, 'Cognito를 통한 사용자 관리 시, 내부 서비스거나 관리자 계정만 발급해야 하는 경우 Self Sign Up 비활성화', true, '2025-10-20 18:08:41.614825', '2025-10-20 18:08:41.614825', 2);
INSERT INTO public.checklists VALUES (49, 1, 18, 42, 'CloudFormation을 위한 IAM 역할 정책 속 두개의 권한(CloudFormation:CreateStack, iam:PassRole)을 동시 부여 제한', true, '2025-10-20 18:14:16.366175', '2025-10-20 18:14:16.366175', 2);
INSERT INTO public.checklists VALUES (50, 1, 19, 43, 'OpenSearch 도메인의 네트워크가 VPC 액세스 전용으로 설정', true, '2025-10-20 18:14:29.904989', '2025-10-20 18:14:29.904989', 2);
INSERT INTO public.checklists VALUES (51, 1, 19, 43, 'OpenSearch 도메인의 액세스 정책이 IP 또는 특정 IAM 역할/사용자로 제한', true, '2025-10-20 18:14:38.98094', '2025-10-20 18:14:38.98094', 2);
INSERT INTO public.checklists VALUES (52, 1, 20, 44, 'Elastic Beanstalk 환경 속성 속 소스가 Secrets Manager 혹은 SSM Parameter Store로 지정', true, '2025-10-20 18:14:48.89713', '2025-10-20 18:14:48.89713', 2);
INSERT INTO public.checklists VALUES (53, 1, 21, 45, 'Redshift 클러스터 암호화', true, '2025-10-20 18:15:00.48116', '2025-10-20 18:15:00.48116', 2);
INSERT INTO public.checklists VALUES (54, 1, 22, 46, 'Glue를 위한 IAM 역할 정책 속 두개의 권한(glue:CreateDevEndpoint, iam:PassRole)의 동시 부여 제한', true, '2025-10-20 18:15:10.810037', '2025-10-20 18:15:10.810037', 2);
INSERT INTO public.checklists VALUES (55, 1, 23, 47, '조직 내 Service Catalog 포트폴리오 공유가 필요한 경우, 조직 전체에 AcceptPortfolioShare 차단하는 SCP 정책 작성 및 조직 구조 내의 공유 방법 선택', true, '2025-10-20 18:15:21.608689', '2025-10-20 18:15:21.608689', 2);
INSERT INTO public.checklists VALUES (56, 1, 23, 47, 'Service Catalog 제약 조건 생성 시 할당하는 IAM 역할에 Principal은 Service Catalog 서비스 지정, Action은 고위험 권한(ex. iam:CreatePolicy, iam:AttachRolePolicy) Deny, Condition은 호출 출처 제한', true, '2025-10-20 18:15:38.330577', '2025-10-20 18:15:38.330577', 2);
INSERT INTO public.checklists VALUES (57, 1, 24, 48, 'DocumentDB 스냅샷의 공유 속성이 프라이빗 설정', true, '2025-10-20 18:15:47.064494', '2025-10-20 18:15:47.064494', 2);
INSERT INTO public.checklists VALUES (58, 1, 24, 48, 'DocumentDB 스냅샷 생성할 클러스터의 KMS 암호화', true, '2025-10-20 18:15:56.027834', '2025-10-20 18:15:56.027834', 2);
INSERT INTO public.checklists VALUES (59, 1, 25, 49, 'Bedrock 모델 활성화/호출 계열 권한(ex. bedrock:InvokeModel)을 특정 모델 ARN으로, Condition을 호출 리전/주체로 제한', true, '2025-10-20 18:16:07.552612', '2025-10-20 18:16:07.552612', 2);
INSERT INTO public.checklists VALUES (60, 1, 26, 50, 'SES 고위험 권한(ex. SendEmail, PutAccountDetails)을 승인된 관리자 또는 서비스 전용 IAM 역할에만 허용', true, '2025-10-20 18:16:20.276733', '2025-10-20 18:16:20.276733', 2);
INSERT INTO public.checklists VALUES (61, 1, 26, 50, 'SES를 위한 IAM 역할 정책 속 Resource를 구체적인 ARN, 도메인, 아이덴티티로 제한', true, '2025-10-20 18:16:28.95513', '2025-10-20 18:16:28.95513', 2);
INSERT INTO public.checklists VALUES (62, 1, 27, 51, 'AppStream의 Fleet/이미지 빌더에 연결된 IAM 역할 정책 속 Resource를 특정 IAM 역할의 ARN으로 제한', true, '2025-10-20 18:16:38.139084', '2025-10-20 18:16:38.139084', 2);
...
INSERT INTO public.guideline_links VALUES (146, 49, 'https://www.wiz.io/blog/jinx-2401-llm-hijacking-aws', 'Wiz(2024, 12) - Bedrock InvokeModel을 이용한 LLM 하이재킹', NULL, '2025-10-20 16:47:34.283226');
INSERT INTO public.guideline_links VALUES (147, 49, 'https://www.csoonline.com/article/3535433/llmjacking-how-attackers-use-stolen-aws-credentials-to-enable-llms-and-rack-up-costs-for-victims.html', 'CSO(2024, 09) - AWS 환경 내 LLMjacking 공격 사례 연구 및 AI 서비스 보안 대책', NULL, '2025-10-20 16:47:34.287451');
INSERT INTO public.guideline_links VALUES (148, 49, 'https://aws.amazon.com/ko/blogs/security/implementing-least-privilege-access-for-amazon-bedrock', 'AWS Security Blog(2025, 02) - Amazon Bedrock 애플리케이션에 대한 최소 권한 원칙', NULL, '2025-10-20 16:47:34.290923');
INSERT INTO public.guideline_links VALUES (149, 49, 'https://www.trendmicro.com/cloudoneconformity/knowledge-base/aws/Bedrock/service-role-policy-too-permissive.html', 'TrendMicro - Amazon Bedrock 서비스 역할의 과도한 권한 위험 및 최소 권한 적용 방안', NULL, '2025-10-20 16:47:34.294213');
INSERT INTO public.guideline_links VALUES (150, 50, 'https://www.wiz.io/blog/wiz-discovers-cloud-email-abuse-campaign', 'Wiz(2025, 09) - 유출된 AWS 키를 이용한 클라우드 이메일 서비스(SES) 탈취 및 피싱 캠페인', NULL, '2025-10-20 16:48:22.254837');
INSERT INTO public.guideline_links VALUES (151, 50, 'https://cyberpress.org/amazon-ses-phishing', 'cyberpress(2025, 09) - Amazon SES 피싱 공격 분석: 도난 자격증명과 다중 리전 PutAccountDetails 악용을 통한 샌드박스 우회', NULL, '2025-10-20 16:48:22.258975');
INSERT INTO public.guideline_links VALUES (152, 51, 'https://www.youtube.com/watch?v=Stf5pf3ERCY', 'DEF CON30(2022, 08) - Appstream 권한 상승의 위험성', NULL, '2025-10-20 16:49:00.088175');
...
INSERT INTO public.guideline_links VALUES (41, 11, 'https://redhuntlabs.com/blog/scanning-millions-of-publicly-exposed-docker-containers-thousands-of-secrets-leaked/', 'RedHunt Labs(2021, 11) - 도커 허브 상의 이미지 내 AWS 민감 정보 유출', NULL, '2025-10-19 21:48:03.448687');
INSERT INTO public.guideline_links VALUES (42, 11, 'https://blog.emberjs.com/security-incident-aws-s3-key-exposure/', 'Credentials leaked in npm package(2016, 12) - 웹 소스코드 내 S3 Access Key 유출', NULL, '2025-10-19 21:48:03.454585');
INSERT INTO public.guideline_links VALUES (43, 11, 'https://www.bleepingcomputer.com/news/security/thousands-of-images-on-docker-hub-leak-auth-secrets-private-keys', 'BleepingComputer(2023, 07) - 개발자 부주의로 인한 Docker 이미지 내 민감 정보 유출', NULL, '2025-10-19 21:48:03.459634');
INSERT INTO public.guideline_links VALUES (44, 11, 'https://www.thestack.technology/infosys-leak-aws-key-exposed-on-pypi', 'THE STACK(2022, 11) - PyPI에 최고 관리자(God Mode) AWS S3 키 노출', NULL, '2025-10-19 21:48:03.464049');
INSERT INTO public.guideline_links VALUES (45, 12, 'https://web.archive.org/web/20210127001214/https://threatpost.com/data-from-august-breach-of-amazon-partner-juspay-dumped-online/162740/', 'Juspay (2021, 01) - 마스킹된 카드 데이터, 이메일 ID 및 전화번호 유출', NULL, '2025-10-19 21:48:51.618788');
INSERT INTO public.guideline_links VALUES (46, 12, 'https://www.invictus-ir.com/news/ransomware-in-the-cloud', 'Invictus(2024, 01) - 장기 자격증명 유출로 인한 랜섬웨어', NULL, '2025-10-19 21:48:51.622006');
INSERT INTO public.guideline_links VALUES (47, 12, 'https://securitylabs.datadoghq.com/articles/tales-from-the-cloud-trenches-the-attacker-doth-persist-too-much', 'securitylabs(2025, 05) - AWS 장기 액세스 키 오용 및 신종 지속성 기법 식별', NULL, '2025-10-19 21:48:51.625646');
INSERT INTO public.guideline_links VALUES (48, 13, 'https://www.breaches.cloud/incidents/chegg/', 'Chegg(2018, 04) - 루트 자격증명 관리 실패', NULL, '2025-10-19 21:50:12.563339');
INSERT INTO public.guideline_links VALUES (49, 13, 'https://web.archive.org/web/20210128055101/https://expel.io/blog/behind-the-scenes-expel-soc-alert-aws/', 'Expel (2020,07) - Root access key 유출로 인한 크립토마이닝', NULL, '2025-10-19 21:50:12.567702');
INSERT INTO public.guideline_links VALUES (50, 13, 'https://medium.com/%40kariarce2377/my-horror-story-discovering-that-my-aws-root-account-was-hacked-2cf3ce41bc47', 'Medium(2025,09) - AWS 루트 계정 침해 사례 및 보안 모범 사례의 중요성', NULL, '2025-10-19 21:50:12.57118');
INSERT INTO public.guideline_links VALUES (51, 14, 'https://hackingthe.cloud/aws/exploitation/Misconfigured_Resource-Based_Policies/misconfigured_iam_role_trust_policy_wildcard_principal/', 'Hacking The Cloud(2024, 01) - 와일드카드를 남용한 잘못된 신뢰 정책', NULL, '2025-10-19 21:50:59.800468');
INSERT INTO public.guideline_links VALUES (52, 14, 'https://www.netspi.com/blog/technical-blog/cloud-penetration-testing/pivoting-clouds-aws-organizations-part-1/', 'NetSPI(2023, 03) - 계정 생성, 신뢰할 수 있는 액세스 및 위임된 관리', NULL, '2025-10-19 21:50:59.803721');
INSERT INTO public.guideline_links VALUES (53, 15, 'https://www.praetorian.com/blog/privilege-escalation-in-aws-with-passrole-attacks/', 'Praetorian(2018, 10) - iam:PassRole 악용을 통한 AWS 권한 상승 및 네트워크 우회 공격 사례', NULL, '2025-10-19 21:51:54.341929');
INSERT INTO public.guideline_links VALUES (54, 15, 'https://www.tenable.com/blog/auditing-iampassrole-a-problematic-privilege-escalation-permission', 'tenable(2021, 01) - AWS iam:PassRole 권한 오용 위험 및 최소 권한 감사 방안', NULL, '2025-10-19 21:51:54.346224');
INSERT INTO public.guideline_links VALUES (55, 15, 'https://aws.amazon.com/ko/blogs/security/how-to-use-the-passrole-permission-with-iam-roles/', 'AWS Security Blog(2023, 11) - AWS IAM 역할과 iam:PassRole 권한 사용 방법 및 보안 모범 사례', NULL, '2025-10-19 21:51:54.352846');
INSERT INTO public.guideline_links VALUES (56, 16, 'https://www.crowdstrike.com/en-us/blog/how-adversaries-persist-with-aws-user-federation/', 'crowdstrike (2023, 01) - 잘못된 Federation 방식 사용 사례', NULL, '2025-10-19 21:52:56.799686');
INSERT INTO public.guideline_links VALUES (57, 16, 'https://expel.com/wp-content/uploads/2025/01/Expel-Annual-Threat-Report-2025-013025.pdf', 'Expel (2025, 01) - Okta SSO 사용으로 인한 AWS 침해', NULL, '2025-10-19 21:52:56.802041');
INSERT INTO public.guideline_links VALUES (58, 17, 'https://www.slideshare.net/slideshow/saaspocalypse-the-complexity-and-power-of-aws-cross-account-access/237678222', 'SaaSpocalypse(2020, 08) - AWS Cross-Account 접근의 위험 분석 및 External ID 기반 보안 강화 전략', NULL, '2025-10-19 21:53:41.564888');
INSERT INTO public.guideline_links VALUES (59, 17, 'https://www.praetorian.com/blog/aws-iam-assume-role-vulnerabilities', 'praetorian(2020, 06) - 잘못된 ExternalId 구현이 AWS 고객 계정 권한 상승을 초래', NULL, '2025-10-19 21:53:41.570006');
INSERT INTO public.guideline_links VALUES (60, 18, 'https://www.breaches.cloud/incidents/first-republic/', 'irst Republic Bank(2020, 02) - 해고된 직원에 의한 데이터 유출', NULL, '2025-10-19 22:21:29.572568');
INSERT INTO public.guideline_links VALUES (61, 18, 'https://rubycentral.org/news/rubygems-org-aws-root-access-event-september-2025/', 'Rubygems.org (2025, 09) - 전임 관리자 계정 권한 미회수로 AWS 루트 접근 유출 및 보안 비상사태 발생', NULL, '2025-10-19 22:21:29.575238');
INSERT INTO public.guideline_links VALUES (62, 19, 'https://www.breaches.cloud/incidents/first-republic/', 'irst Republic Bank(2020, 02) - 해고된 직원에 의한 데이터 유출', NULL, '2025-10-19 22:22:12.496963');
INSERT INTO public.guideline_links VALUES (63, 19, 'https://rubycentral.org/news/rubygems-org-aws-root-access-event-september-2025/', 'Rubygems.org (2025, 09) - 전임 관리자 계정 권한 미회수로 AWS 루트 접근 유출 및 보안 비상사태 발생', NULL, '2025-10-19 22:22:12.500196');
INSERT INTO public.guideline_links VALUES (67, 20, 'https://frichetten.com/blog/abusing-aws-connection-tracking/', 'frichetten(2020, 08) - AWS 연결 추적 남용', NULL, '2025-10-20 14:29:21.219218');
INSERT INTO public.guideline_links VALUES (68, 20, 'https://www.boannews.com/media/view.asp?idx=101097', '보안뉴스(2021, 09) - 국내 4개 사업자 AWS 관리자 접근권한 제한 부재', NULL, '2025-10-20 14:29:21.225123');
INSERT INTO public.guideline_links VALUES (69, 20, 'https://cybersapiens.com.au/identifying-misconfigured-security-groups-unrestricted-traffic-and-public-facing-endpoints', 'yberSapiens(2025, 05) - 보안 그룹 오설정 진단: ''0.0.0.0/0'' 개방으로 인한 공용 접근', NULL, '2025-10-20 14:29:21.22886');
INSERT INTO public.guideline_links VALUES (73, 22, 'https://hackingthe.cloud/aws/exploitation/lambda-steal-iam-credentials/', 'Hacking The Cloud(2020, 08) - AWS Lambda 환경 변수/런타임 API 악용을 통한 IAM 자격증명 탈취', NULL, '2025-10-20 14:32:48.594985');
INSERT INTO public.guideline_links VALUES (74, 22, 'https://unit42.paloaltonetworks.com/compromised-cloud-compute-credentials', 'UNIT 42(2022, 12) - AWS Lambda 환경변수 악용을 통한 공격', NULL, '2025-10-20 14:32:48.598781');
INSERT INTO public.guideline_links VALUES (75, 23, 'https://github.com/RhinoSecurityLabs/cloudgoat/tree/master/cloudgoat/scenarios/aws/vulnerable_lambda', 'CloudGoat - 취약한 lambda를 이용한 AWS 계정 권한 상승', NULL, '2025-10-20 16:20:01.879554');
INSERT INTO public.guideline_links VALUES (76, 23, 'https://rhinosecuritylabs.com/cloud-security/cloudgoat-vulnerable-lambda-functions/', 'RHINO SECURITY LABS - 취약한 AWS Lambda 함수(SQL Injection)를 이용한 권한 상승 경로', NULL, '2025-10-20 16:20:01.884011');
INSERT INTO public.guideline_links VALUES (77, 23, 'https://docs.aws.amazon.com/inspector/latest/user/scanning_resources_lambda_code.html', 'aws User Guide - Inspector Lambda 코드 스캐닝', NULL, '2025-10-20 16:20:01.886947');
INSERT INTO public.guideline_links VALUES (78, 24, 'https://www.mitiga.io/blog/how-mitiga-found-pii-in-exposed-amazon-rds-snapshots', 'Mitiga(2020, 08) - RDS 스냅샷 공개 설정으로 인한 데이터 유출', NULL, '2025-10-20 16:21:47.642148');
INSERT INTO public.guideline_links VALUES (79, 24, 'https://www.clouddefense.ai/compliance-rules/cisa-cyber-essentials/systems/rds-db-snapshot-prohibit-public-access', 'CloudDefense.AI - RDS 스냅샷 공개 액세스 금지', NULL, '2025-10-20 16:21:47.64462');
INSERT INTO public.guideline_links VALUES (80, 24, 'https://gbhackers.com/amazon-rds-instances-leaking-user-data', 'gbhackers(2022, 11) - RDS 스냅샷의 부주의한 공개 공유로 인한 대규모 고객 데이터 유출', NULL, '2025-10-20 16:21:47.648639');
INSERT INTO public.guideline_links VALUES (81, 24, 'https://www.secureblink.com/cyber-security-news/millions-of-corporate-pi-is-leaked-from-vulnerable-amazon-rds-snapshots', 'SecureBlink(2022, 11) - 잘못 구성된 Amazon RDS 공개 스냅샷으로 인한 기업 PII 노출', NULL, '2025-10-20 16:21:47.651215');
INSERT INTO public.guideline_links VALUES (84, 26, 'https://expel.com/blog/finding-evil-in-aws/', 'expel(2020, 04) - CloudTrail 활성화를 통한 공격 징후 탐지 및 차단 사례', NULL, '2025-10-20 16:23:38.881878');
INSERT INTO public.guideline_links VALUES (85, 26, 'https://medium.com/starting-up-security/investigating-cloudtrail-logs-c2ecdf578911', 'Medium(2016, 11) - AWS 침해 사고 대응을 위한 CloudTrail 로그 분석', NULL, '2025-10-20 16:23:38.890987');
INSERT INTO public.guideline_links VALUES (86, 26, 'https://www.sysdig.com/blog/cloud-breach-terraform-data-theft', 'Sysdig(2023, 02) - SCARLETEEL 공격자가 AWS CloudTrail 로깅을 중단하고 데이터 절도 수행', NULL, '2025-10-20 16:23:38.896761');
INSERT INTO public.guideline_links VALUES (87, 27, 'https://expel.com/blog/incident-report-from-cli-to-console-chasing-an-attacker-in-aws/', 'expel(2022, 04) - 의심 API 조합을 통한 조기 탐지 및 대응 사례', NULL, '2025-10-20 16:24:33.008456');
INSERT INTO public.guideline_links VALUES (88, 27, 'https://www.sysdig.com/blog/cloud-threats-deploying-crypto-cdn', 'Sysdig(2024, 03) - AWS 클라우드 자원을 악용한 크립토 CDN 공격 분석', NULL, '2025-10-20 16:24:33.012186');
INSERT INTO public.guideline_links VALUES (89, 28, 'https://www.crn.com/news/cloud/2025/aws-eks-kubernetes-critical-security-flaw-exposes-credentials1', 'CRN(2025, 06) - AWS EKS Pod Identity 오설정으로 인한 클러스터 자격증명 노출 위험', NULL, '2025-10-20 16:26:10.903854');
INSERT INTO public.guideline_links VALUES (90, 28, 'https://www.slideshare.net/slideshow/exploit-k8s-via-misconfiguration-yaml-in-csp-environments/273379601#11', 'EF CON32(2024, 08) - Kubernetes RBAC 및 Pod Security Context 오설정을 통한 권한 확대 방안', NULL, '2025-10-20 16:26:10.91316');
INSERT INTO public.guideline_links VALUES (91, 28, 'https://aws.amazon.com/ko/blogs/security/how-to-detect-security-issues-in-amazon-eks-clusters-using-amazon-guardduty-part-1', 'AWS Security Blog(2022, 11) - Amazon EKS 오설정(Anonymous Access)이 랜섬웨어 공격으로 이어지는 5단계 분석', NULL, '2025-10-20 16:26:10.919285');
INSERT INTO public.guideline_links VALUES (92, 29, 'https://www.youtube.com/watch?v=8QdZ2-sAQFs', 'DEF CON 28(2020, 08) - KMS 정책 오설정을 악용한 랜섬웨어 공격', NULL, '2025-10-20 16:27:04.104686');
INSERT INTO public.guideline_links VALUES (93, 29, 'https://blog.pwnedlabs.io/ransomwhen-the-hidden-risks-of-aws-kms-in-ransomware-attacks?utm_source', 'PWNED LABS(2025, 03) - AWS KMS BYOKM 기능을 악용한 클라우드 랜섬웨어 공격 분석 및 탐지 전략', NULL, '2025-10-20 16:27:04.122577');
INSERT INTO public.guideline_links VALUES (94, 29, 'https://permiso.io/blog/ransomwhen-i-did-not-even-notice-it', 'Permiso(2025, 02) - KMS 키를 이용한 S3 버킷 데이터 암호화 랜섬웨어 공격', NULL, '2025-10-20 16:27:04.128847');
INSERT INTO public.guideline_links VALUES (95, 30, 'https://securitylabs.datadoghq.com/articles/tales-from-the-cloud-trenches-aws-activity-to-phishing/', 'Datadog(2024, 03) - Datadog Threat Detection 팀의 SMS 발송 설정 열거 악성 활동', NULL, '2025-10-20 16:28:55.821855');
INSERT INTO public.guideline_links VALUES (96, 30, 'https://tutorgeeks.blogspot.com/2019/11/publicly-exposed-aws-sns-topics.html', 'Tutorgeeks(2019, 04) - 토픽 공개 노출 위협: 구독/발행 권한 오용으로 인한 데이터 유출 및 스팸 공격', NULL, '2025-10-20 16:28:55.82766');
INSERT INTO public.guideline_links VALUES (97, 31, 'https://rodelllemit.medium.com/aws-pentesting-abusing-overly-permissive-sqs-queue-156297205afe', 'Medium(2025, 01) - AWS SQS 큐 정책을 악용한 민감 정보 탈취 사례', NULL, '2025-10-20 16:29:46.812866');
INSERT INTO public.guideline_links VALUES (98, 31, 'https://www.plerion.com/blog/your-queues-your-responsibility', 'plerion(2024, 08) - AWS SQS 큐 공개 노출 위험: 잘못된 정책 설정으로 인한 메시지 주입 및 데이터 탈취', NULL, '2025-10-20 16:29:46.818126');
INSERT INTO public.guideline_links VALUES (99, 32, 'https://hackerone.com/reports/1179193', 'Hackerone(2021, 04) - 삭제된 EC2 인스턴스 미관리로 인한 서브도메인 탈취', NULL, '2025-10-20 16:30:42.235932');
INSERT INTO public.guideline_links VALUES (100, 32, 'https://hackingthe.cloud/aws/exploitation/orphaned_cloudfront_or_dns_takeover_via_s3/', 'Hacking The Cloud(2021, 03) - 삭제된 S3 미관리로 인한 서브도메인 탈취', NULL, '2025-10-20 16:30:42.239329');
INSERT INTO public.guideline_links VALUES (101, 32, 'https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/protection-from-dangling-dns.html', 'AWS Developer Guide - AWS Route 53 Dangling Delegation Records 방지 가이드', NULL, '2025-10-20 16:30:42.242756');
INSERT INTO public.guideline_links VALUES (102, 32, 'https://blogs.infoblox.com/threat-intelligence/cloudy-with-a-chance-of-hijacking-forgotten-dns-records-enable-scam-actor/', 'infoblox(2025, 05) - Dangling CNAME 기록을 통한 CDC 등 주요 기관 서브도메인 탈취', NULL, '2025-10-20 16:30:42.247269');
INSERT INTO public.guideline_links VALUES (103, 33, 'https://securitylabs.datadoghq.com/articles/tales-from-the-cloud-trenches-the-attacker-doth-persist-too-much/', 'Datadog Security Labs(2025, 05) - AWS 침투 후 공격자 지속성 확보 신규 전술 분석', NULL, '2025-10-20 16:31:35.51795');
INSERT INTO public.guideline_links VALUES (104, 33, 'https://hackingthe.cloud/aws/general-knowledge/aws_organizations_defaults/', 'Hacking The Cloud(2022, 11) - AWS Organizations 기본 설정의 보안 취약점과 피보팅 경로', NULL, '2025-10-20 16:31:35.522816');
INSERT INTO public.guideline_links VALUES (105, 33, 'https://www.netspi.com/blog/technical-blog/cloud-pentesting/pivoting-clouds-aws-organizations-part-1/', 'netspi(2023, 03) - AWS Organizations 권한 확장분석: 계정 생성 및 Trusted Access 취약점 활용', NULL, '2025-10-20 16:31:35.527717');
INSERT INTO public.guideline_links VALUES (106, 34, 'https://hackingthe.cloud/aws/general-knowledge/block-expensive-actions-with-scps/', 'Hacking The Cloud(2024, 07) -  AWS SCP를 활용한 고비용 API 호출 방지 전략', NULL, '2025-10-20 16:32:15.988849');
INSERT INTO public.guideline_links VALUES (107, 35, 'https://medium.com/ironsource-tech-blog/abusing-elastic-container-registry-ecr-to-own-aws-environments-47534ad61729', 'ironSource (2022,08) - ECR 권한 정책 오용으로 AWS 환경 장악', NULL, '2025-10-20 16:33:27.681483');
INSERT INTO public.guideline_links VALUES (108, 35, 'https://hackingthe.cloud/aws/exploitation/Misconfigured_Resource-Based_Policies/misconfigured_ecr_resource_policy/', 'Hacking The Cloud(2022, 11) - ECR 리소스 정책 오용 및 컨테이너 이미지 탈취/변조 공격', NULL, '2025-10-20 16:33:27.685867');
INSERT INTO public.guideline_links VALUES (109, 35, 'https://docs.prismacloud.io/en/enterprise-edition/policy-reference/aws-policies/public-policies/public-1-ecr-repositories-not-public', 'prismacloud(2025, 06) - 공개 접근 허용 ECR 리포지토리 탐지 및 차단 정책', NULL, '2025-10-20 16:33:27.689405');
INSERT INTO public.guideline_links VALUES (110, 36, 'https://medium.com/%40adammesser_51095/cloud-digital-forensics-and-incident-response-aws-iam-privilege-escalation-leads-to-ec2-2d787a4e99a7', 'Medium(2024, 08) - AWS Systems Manager(SSM) Run Command 악용을 통한 시스템 수준 랜섬웨어 배포', NULL, '2025-10-20 16:34:35.73768');
INSERT INTO public.guideline_links VALUES (111, 36, 'https://hackingthe.cloud/aws/post_exploitation/run_shell_commands_on_ec2/', 'Hacking The Cloud(2022, 04) - AWS SSM을 이용한 EC2 셸 명령 실행 및 악용 방안', NULL, '2025-10-20 16:34:35.74353');
INSERT INTO public.guideline_links VALUES (112, 36, 'https://www.elastic.co/guide/en/security/8.19/aws-ssm-sendcommand-with-run-shell-command-parameters.html', 'elastic - SSM SendCommand를 통한 악성 쉘 명령 실행 탐지 및 분석', NULL, '2025-10-20 16:34:35.748579');
INSERT INTO public.guideline_links VALUES (113, 36, 'https://securitycafe.ro/2023/01/17/aws-post-explitation-with-ssm-sendcommand', 'securitycafe(2023, 01) - AWS SSM SendCommand 오용: 네트워크 독립적 루트 권한 원격 코드 실행(RCE) 공격', NULL, '2025-10-20 16:34:35.753478');
INSERT INTO public.guideline_links VALUES (114, 37, 'https://research.checkpoint.com/2021/the-need-to-protect-public-aws-ssm-documents-what-the-research-shows/', 'CHECK POINT(2021, 05) - AWS SSM 문서의 공개 설정 위험성 분석 및 데이터 노출 방지 대책', NULL, '2025-10-20 16:35:21.943772');
INSERT INTO public.guideline_links VALUES (115, 37, 'https://ramimac.me/ssm-command-docs', 'High Signal Security(2024, 06) - 공개 SSM 명령 문서(Command Documents)를 통한 민감 정보 및 접근 키 노출', NULL, '2025-10-20 16:35:21.947361');
INSERT INTO public.guideline_links VALUES (116, 37, 'https://hackernoon.com/how-aws-misconception-resulted-in-detection-of-5-million-personal-records', 'Hackernoon(2022, 01) - AWS SSM 문서 공유 : 500만 건 개인 정보 유출 사례 분석 및 보안 방안', NULL, '2025-10-20 16:35:21.951233');
INSERT INTO public.guideline_links VALUES (117, 38, 'https://aws.github.io/aws-security-services-best-practices/guides/guardduty/', 'AWS Security Services Best Practices - AWS 클라우드 위협 탐지를 위한 GuardDuty 활용 가이드', NULL, '2025-10-20 16:36:15.941777');
INSERT INTO public.guideline_links VALUES (118, 38, 'https://github.com/aws-samples/aws-incident-response-playbooks/tree/master/playbooks', 'aws-incident-response-playbooks - GuardDuty 미설정으로 인한 인시던트', NULL, '2025-10-20 16:36:15.947494');
INSERT INTO public.guideline_links VALUES (119, 38, 'https://veriti.ai/blog/inside-amazon-guardduty-what-the-logs-reveal-about-cloud-security', 'Veriti Research(2025, 02) - Amazon GuardDuty 로그 기반 클라우드 보안 위협 분석 및 통찰', NULL, '2025-10-20 16:36:15.951929');
INSERT INTO public.guideline_links VALUES (122, 40, 'https://hackingthe.cloud/aws/exploitation/cognito_user_self_signup/', 'Hacking The Cloud(2023, 06) - 의도하지 않은 Cognito의 Self-Signup', NULL, '2025-10-20 16:38:32.127102');
INSERT INTO public.guideline_links VALUES (123, 40, 'https://security.theodo.com/en/blog/aws-cognito-pentest', 'theodo(2023, 07) - Self Sign-up 악용 및 임시 자격증명 탈취', NULL, '2025-10-20 16:38:32.133163');
INSERT INTO public.guideline_links VALUES (124, 39, 'https://hackingthe.cloud/aws/exploitation/cognito_identity_pool_excessive_privileges/', 'Hacking The Cloud(2023, 06) - Cognito Identity Pool의 과도한 권한 설정', NULL, '2025-10-20 16:38:43.38004');
INSERT INTO public.guideline_links VALUES (125, 39, 'https://blog.appsecco.com/exploiting-weak-configurations-in-amazon-cognito-in-aws-471ce761963', 'Appsecco(2021, 04) - Amazon Cognito 취약한 구성을 이용한 임시 AWS 자격증명 확보 및 악용', NULL, '2025-10-20 16:38:43.387756');
INSERT INTO public.guideline_links VALUES (126, 41, 'https://security.theodo.com/en/blog/aws-cognito-pentest', 'Flickr(2021, 12) - Cognito user 이메일 속성 변경으로 인한 계정 탈취', NULL, '2025-10-20 16:39:34.485858');
INSERT INTO public.guideline_links VALUES (127, 41, 'https://medium.com/@mukundbhuva/account-takeover-due-to-cognito-misconfiguration-earns-me-xxxx-3a7b8bb9a619', 'Medium(2022, 12) - Cognito 설정 오류로 인한 계정 탈취 및 정보 접근', NULL, '2025-10-20 16:39:34.489077');
INSERT INTO public.guideline_links VALUES (128, 42, 'https://www.prodefense.io/blog/aws-cloudformation-takeover?utm_source', 'ProDefense(2023, 02) - CloudFormation 스택 생성 권한을 악용한 권한 상승 공격 분석', NULL, '2025-10-20 16:40:53.070798');
INSERT INTO public.guideline_links VALUES (129, 42, 'https://docs.datadoghq.com/ko/security/code_security/iac_security/iac_rules/terraform/aws/role_with_privilege_escalation_by_actions_iam_passrole_and_cloudformation_createstack/?utm_source', 'Datadog - AWS CloudFormation 및 PassRole 설정으로 인한 IAM 권한 에스컬레이션 방지', NULL, '2025-10-20 16:40:53.075909');
INSERT INTO public.guideline_links VALUES (130, 42, 'https://infosecwriteups.com/passing-a-role-to-cloudformation-to-escalate-privileges-602010d26f55', 'Medium(2022, 09) - AWS CloudFormation 역할 전달(iam:PassRole) 취약점을 이용한 권한 상승 공격 분석', NULL, '2025-10-20 16:40:53.079748');
INSERT INTO public.guideline_links VALUES (131, 42, 'https://blog.prodefense.io/how-abusing-aws-cloudformation-led-to-a-total-takeover-of-an-aws-environment-7f94cabd671d', 'Medium(2023, 07) - CloudFormation과 iam:PassRole 권한 남용을 통한 관리자 사용자 생성 공격', NULL, '2025-10-20 16:40:53.085818');
INSERT INTO public.guideline_links VALUES (132, 43, 'https://www.clouddefense.ai/compliance-rules/aws-fs-practices/opensearch/opensearch-in-vpc-only', 'CloudDefense.AI -  AWS OpenSearch 도메인에 대한 최소 권한 기반 접근 통제 구현', NULL, '2025-10-20 16:41:37.269563');
INSERT INTO public.guideline_links VALUES (133, 43, 'https://www.trendmicro.com/cloudoneconformity/knowledge-base/aws/Elasticsearch/domain-exposed.html', 'TrendMirco - AWS OpenSearch 서비스: 공개 도메인 노출 위험과 액세스 정책 강화 방안', NULL, '2025-10-20 16:41:37.273106');
INSERT INTO public.guideline_links VALUES (134, 44, 'https://rhinosecuritylabs.com/tools/new-pacu-module-enumerating-elastic-beanstalk/', 'RHINO - Pacu 모듈로 Elastic Beanstalk 시크릿 열거', NULL, '2025-10-20 16:42:31.699608');
INSERT INTO public.guideline_links VALUES (135, 44, 'https://medium.com/%40mauzware/day-6-of-my-aws-pentesting-journey-exploring-elastic-beanstalk-adc28ea74f0d', 'Medium(2025, 05) - Pacu 모듈을 통한 Beanstalk 내부 하드코딩 시크릿 탐지', NULL, '2025-10-20 16:42:31.706114');
INSERT INTO public.guideline_links VALUES (136, 44, 'https://aws.plainenglish.io/hacking-aws-beanstalk-cloudgoat-scenario-4da1fac6a4cf', 'Medium(2025, 06) - AWS Beanstalk 보안: 환경 변수 내 민감 정보 저장을 통한 계정 전체 탈취 경로', NULL, '2025-10-20 16:42:31.712483');
INSERT INTO public.guideline_links VALUES (137, 45, 'https://www.fogsecurity.io/blog/shifty-business-redshift-encryption-aws', 'fogsecurity(2025, 04) - AWS Redshift의 암호화 기본 설정 우회 및 보안 감사 미비점 분석', NULL, '2025-10-20 16:43:41.177602');
INSERT INTO public.guideline_links VALUES (138, 45, 'https://aws.amazon.com/ko/blogs/security/amazon-redshift-enhances-security-by-changing-default-behavior-in-2025/', 'AWS Security Blog(2025, 01) - Redshift 기본 보안 강화', NULL, '2025-10-20 16:43:41.180361');
INSERT INTO public.guideline_links VALUES (139, 46, 'https://hackingthe.cloud/aws/exploitation/iam_privilege_escalation/', 'Hacking The Cloud (2021, 11) - AWS IAM 권한 상승 공격 기법 분석', NULL, '2025-10-20 16:44:33.287793');
INSERT INTO public.guideline_links VALUES (140, 46, 'https://docs.kics.io/develop/queries/terraform-queries/aws/94fbe150-27e3-4eba-9ca6-af32865e4503/', 'KICS - AWS Glue 개발 엔드포인트 생성 권한을 악용한 IAM 권한 에스컬레이션 방지', NULL, '2025-10-20 16:44:33.291232');
INSERT INTO public.guideline_links VALUES (141, 46, 'https://bishopfox.com/blog/5-privesc-attack-vectors-in-aws', 'BISHOPFOX(2019, 12) - AWS Glue 개발 엔드포인트 수정 권한을 이용한 권한 상승 위험', NULL, '2025-10-20 16:44:33.294545');
INSERT INTO public.guideline_links VALUES (142, 47, 'https://www.slideshare.net/secret/56jgTgG070ec4j', 'DEF CON 31(2023, 08) - Service Catalog 관리자 권한을 이용한 권한 상승 취약점', NULL, '2025-10-20 16:45:26.445827');
INSERT INTO public.guideline_links VALUES (143, 47, 'https://docs.aws.amazon.com/servicecatalog/latest/adminguide/constraints-launch.html', 'AWS Docs - AWS Service Catalog Launch Constraint을 활용한 최소 권한 구현', NULL, '2025-10-20 16:45:26.452172');
INSERT INTO public.guideline_links VALUES (144, 48, 'https://ramimac.me/exposed-docdb', 'High Signal Security(2024, 05) - AWS DocumentDB 스냅샷 공개 노출 위험 및 대규모 고객 데이터 유출 사례 분석', NULL, '2025-10-20 16:46:35.892816');
INSERT INTO public.guideline_links VALUES (145, 48, 'https://docs.aws.amazon.com/documentdb/latest/developerguide/backup_restore-share_cluster_snapshots.html?utm_source=chatgpt.com', 'AWS Developer Guide - Amazon DocumentDB: 클러스터 스냅샷 공유 및 복원 가이드', NULL, '2025-10-20 16:46:35.895907');
INSERT INTO public.guideline_links VALUES (157, 25, 'https://www.sysdig.com/blog/aws-rds-security-events-sysdig', 'sysdig(2022, 05) - RDS 인스턴스를 공개로 설정', NULL, '2025-10-20 17:49:36.053283');
INSERT INTO public.guideline_links VALUES (158, 25, 'https://www.blinkops.com/blog/tracking-down-amazon-rds-instances-that-are-publicly-accessible', 'BlinkOps(2022, 02) - 공개적으로 접근 가능한 RDS 인스턴스를 추적하는 방법', NULL, '2025-10-20 17:49:36.057059');
INSERT INTO public.guideline_links VALUES (159, 21, 'https://www.wired.com/story/cryptojacking-tesla-amazon-cloud/', 'Tesla(2018, 02) - 배스천 호스트 미사용으로 인한 ec2 크립토마이닝', NULL, '2025-10-20 21:18:09.267386');
INSERT INTO public.guideline_links VALUES (160, 21, 'https://www.boannews.com/media/view.asp?idx=122816&direct=mobile', 'QubitStrike(2023, 08) -  ec2에 설치된 Jupeternote의 취약점을 이용한 크립토마이', NULL, '2025-10-20 21:18:09.275955');
