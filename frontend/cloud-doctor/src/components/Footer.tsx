      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">CloudDoctor</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/" className="text-slate-400 hover:text-cyan-400 transition-colors text-sm flex items-center gap-2">
                  <span>→</span> 주요 기능
                </a>
              </li>
              <li>
                <a href="#how-it-works" className="text-slate-400 hover:text-cyan-400 transition-colors text-sm flex items-center gap-2">
                  <span>→</span> 이용 방법
                </a>
              </li>
            </ul>
            ...
            <ul className="space-y-2">
              <li>
                <button
                  ...
                  className="text-slate-400 hover:text-violet-400 transition-colors text-sm flex items-center gap-2"
                >
                  <span>→</span> 데모 신청
                </button>
              </li>
              <li>
                <a
                  href="http://pf.kakao.com/_your_kakao_id"
                  target="_blank"
        ...
        <div className="border-t border-slate-800 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4">
            {/* GitHub 링크 - 나중에 주소 추가 */}
            <a href="https://github.com/" className="text-slate-500 hover:text-cyan-400 transition-colors">
