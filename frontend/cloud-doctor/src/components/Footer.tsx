      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">CloudDoctor</span>
            </div>
          ...
          <div>
            <h4 className="font-semibold mb-4 text-white flex items-center gap-2">
              <span className="text-blue-400">■</span> 서비스
            </h4>
            <ul className="space-y-2">
              ...
              <li>
                <a href="#how-it-works" className="text-gray-400 hover:text-blue-400 transition-colors text-sm flex items-center gap-2">
                  <span>→</span> 이용 방법
                </a>
              </li>
            </ul>
          ...
          <div>
            <h4 className="font-semibold mb-4 text-white flex items-center gap-2">
              <span className="text-purple-400">■</span> 문의하기
            </h4>
            <ul className="space-y-2">
              <li>
                <button
        ...
        <div className="border-t border-gray-700 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4">
            {/* GitHub 링크 - 나중에 주소 추가 */}
            <a href="https://github.com/" className="text-gray-500 hover:text-blue-400 transition-colors">
